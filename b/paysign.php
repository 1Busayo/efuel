 ...
 ?> 
          ...
          <div class="panel-body">
			...
			<script src="https://js.paystack.co/v1/inline.js"></script>
              <div class="form-group">
                <input type="email" class="form-control" id="email" name="x4" placeholder="Email" required>
              </div>
			  <div class="form-group">
                <input type="number" class="form-control" id="phone" name="x5" placeholder="Phonenumber" required>
              </div>
            <!--  <div class="form-group">
              ...
              <div class="form-group text-center">
                 <button type="button" class="btn btn-primary btn-lg" onclick="payWithPaystack()"> Pay </button> 
              </div>
  ...
  var price = 4000;
    var handler = PaystackPop.setup({
      ...
      key: 'pk_test_09febf1d62d6d5584cf66318f8d002301f3c3317',
      email:   document.getElementById('email').value,
      amount: price+'00',
	  first_name: 'Bojack',
      last_name:'Dino',
	 // subaccount: 'ACCT_4ftps2hnk9wp41r',
	 //transaction_charge: 75000,
	  //bearer:'subaccount',
