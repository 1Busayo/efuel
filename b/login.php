          ...
          <div class="panel-body">
            ...
            <form role="form" action="" method="POST">
              ...
              <div class="text-center">
               <button type="submit" class="btn btn-success" name="submit">Login <i class="fa fa-fw fa-unlock-alt"></i></button> 
			   <!--<input type="submit" name="submit" class="btn btn-success fa fa-fw fa-unlock-alt" value="Login"> --> <a href="signup" class="btn btn-primary">Register <i class="fa fa-pencil"></i></a>
              </div>
            </form>
